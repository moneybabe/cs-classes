...
def floor_div(expr):
    ...
    # def tail_floor_div(operands, so_far):
    #     if operands.rest is nil:
    #         return so_far // operands.first
    #     else:
    #         return tail_floor_div(operands.rest, so_far // operands.first)
    # return tail_floor_div(expr.rest, expr.first)
